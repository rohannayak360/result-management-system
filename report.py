...
class reportClass:
    def __init__(self, root):
        ...
        self.var_id=""
        lbl_select=Label(self.root,text="Search By Roll No.",font=("goudy old style", 15, "bold"),bg="white").place(x=280,y=100)
        ...
        # label for roll,name,course,marks,full_marks,per
        ...
        lbl_marks=Label(self.root,text="Marks",font=("goudy old style", 15, "bold"),bg="white",bd=2,relief=GROOVE).place(x=600,y=230,width=150,height=50)
