...
class resultClass:
    def __init__(self, root):
        ...
        # button
        btn_search=Button(self.root,text="Search",font=("goudy old style", 15, "bold"),bg="#4caf50",fg="white",cursor="hand2",command=self.search).place(x=500,y=100,width=100,height=28)
        ...
        # buttons
        btn_add=Button(self.root,text="Submit",font=("times new roman", 15),bg="lightgreen",activebackground="#4caf50",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        btn_clear = Button(
            self.root,
            text="Clear",
        ...
        # btn_update=Button(self.root,text="Update",font=("times new roman", 15),bg="#4caf50",activebackground=,fg="white"nd2").place(x=400,y=400,width=100,height=28)
        # btn_delete=Button(self.root,text="Delete",font=("times new roman", 15),bg="#4caf50",activebackground=,fg="white"nd2").place(x=520,y=400,width=100,height=28)

        # image
        self.bg_img = Image.open("images/result.jpg")
        self.bg_img = self.bg_img.resize((500,300), Image.Resampling.LANCZOS)  # Fixed line
